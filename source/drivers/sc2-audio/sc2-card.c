...
{
	return of_device_is_compatible(np, "km6,sc2-tohdmitx-experimental") ||
		of_device_is_compatible(np, DT_PREFIX "g12a-tohdmitx") ||
...
static const struct of_device_id axg_card_of_match[] = {
	{
		.compatible = "km6,sc2-sound-card-experimental",
