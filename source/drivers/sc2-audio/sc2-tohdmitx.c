...
#define G12A_TOHDMITX_DRV_NAME "km6-sc2-tohdmitx"

#define TOHDMITX_CTRL0			0x0
#define  CTRL0_ENABLE_SHIFT		29
...
{
	/* SC2 static clocks must be set here: component probe runs after
	 * platform probe and writes the whole register. Stereo TDM C only.
	 */
	return snd_soc_component_write(c, TOHDMITX_CTRL0,
		     BIT(28) | BIT(20) | BIT(19) | (2 << 16) |
...
static const struct of_device_id g12a_tohdmitx_of_match[] = {
	{ .compatible = "km6,sc2-tohdmitx-experimental", },
	{}
};
